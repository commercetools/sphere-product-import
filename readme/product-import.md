...
### Configuration
  ...
  * configuration object
    ...
    * matchVariantsByAttr: an option to specify variant matching, with that option you could specify a matcher like `sku`. by default variants match first by sku, then by key and then id. 
