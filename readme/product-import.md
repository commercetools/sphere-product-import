...
### Configuration
  ...
  * configuration object
    ...
    * beforeCreateOrUpdateCallback: fn(prodToProcess, existingProducts) -> prodToProcess
      ...
      * this callback must return prodToProcess array with products that will be synced later  
